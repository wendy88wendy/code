...
::创建桌面和根目录快捷方式
mshta VBScript:Execute("Set a=CreateObject(""WScript.Shell""):Set b=a.CreateShortcut(a.SpecialFolders(""%~sdp0\"") & ""ShadowsocksR.lnk""):b.TargetPath=""C:\Program Files\ShadowsocksR-win-4.9.2\ShadowsocksR-dotnet4.0.exe"":b.WorkingDirectory=""%~sdp0"":b.Save:close")
mshta VBScript:Execute("Set a=CreateObject(""WScript.Shell""):Set b=a.CreateShortcut(a.SpecialFolders(""Desktop"") & ""\ShadowsocksR.lnk""):b.TargetPath=""C:\Program Files\ShadowsocksR-win-4.9.2\ShadowsocksR-dotnet4.0.exe"":b.WorkingDirectory=""%~sdp0Program"":b.Save:close")
...
ECHO.&ECHO 安装完成 &TIMEOUT /t 2 >NUL&EXIT